...
let runCommand = command => {
  ...
  try {
    ...
    succeeded = false; // if (error.stderr) {
...
const beginInstallModule = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(function* (name, dev) {
  ...
  return function beginInstallModule(_x3, _x4) {
    return _ref3.apply(this, arguments);
  };
}();

const installModule = /*#__PURE__*/function () {
  ...
  return function installModule(_x5) {
